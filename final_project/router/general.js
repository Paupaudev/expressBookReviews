...
axios.get("https://paulobaldo3-5000.theiadocker-2-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/")
...
const isbn = req.params.isbn;
axios.get(`https://paulobaldo3-5000.theiadocker-2-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/isbn/${isbn}`)
  .then(data => res.send(JSON.stringify(data.data,null,4)))
  .catch(err => next(err));
});
...
const author = req.params.author;
axios.get(`https://paulobaldo3-5000.theiadocker-2-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/author/${author}`)
  .then(data => res.send(JSON.stringify(data.data,null,4)))
  .catch(err => next(err));
});
...
const title = req.params.title;
axios.get(`https://paulobaldo3-5000.theiadocker-2-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/title/${title}`)
  .then(data => res.send(JSON.stringify(data.data,null,4)))
  .catch(err => next(err));
});
